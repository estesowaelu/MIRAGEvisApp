...
void display(void)
{
	...
	MVStudyApp::instance().setSharedHeadMatrix(osg::Matrixf(gCamera.getViewMatrix(CameraController::FPS_VIEW).getInverse().m));
...
void keyboard(unsigned char key, int x, int y)
{
	switch(key)
	{
		...
		case ' ':	MVStudyApp::instance().buttonInput(0, true);	break;		//space bar controls the main wand button
...
//		case '1': MVStudyApp::instance().buttonInput(1, true); break;
		case '0': MVStudyApp::instance().buttonInput(0, true); break;
			
		case 'b': MVStudyApp::instance().triggerInput(1, true); break;
		case 'n': MVStudyApp::instance().triggerInput(2, true); break;
		case 'm': MVStudyApp::instance().triggerInput(3, true); break;
	...
	MVStudyApp::instance().pushTarget();
	glutPostRedisplay();
}
...
void timer(int bl)
{
	...
	if(!gPaused)
		MVStudyApp::instance().update(dt);		//send the timestep to the app class
...
//		case ' ':	MVStudyApp::instance().buttonInput(0, false);	break;		//space bar controls the main wand button
	}
